...
export default async function Dashboard() {
  ...
  const [{ data: operator }, { data: repos }, { data: tasks }, { count: tokenCount }, { data: claims }] = await Promise.all([
  ...
  const data: DashboardData = {
    ...
    repos: (repos ?? []).map((r) => ({ id: r.id, full_name: r.full_name, mine: r.installed_by === user.id })),
